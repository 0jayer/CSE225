...
template <class ItemType>
int CountLeaf(TreeNode<ItemType>* tree)
{
    if (tree == NULL)
        return 0;
        ...
        return CountLeaf(tree->left) +
               CountLeaf(tree->right);
}
template <class ItemType>
...
template <class ItemType>
int CountSingle(TreeNode<ItemType>* tree)
{
     if (tree == nullptr) {
            return 0;
        }
        ...
        count += CountSingle(tree->left);
        count += CountSingle(tree->right);
        return count;
}
template <class ItemType>
int TreeType<ItemType>::SingleCount()
{
